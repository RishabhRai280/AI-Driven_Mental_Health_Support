  ...
  useEffect(() => {
    ...
    const handleMediaChange = (e: MediaQueryListEvent) => {
      const hasExplicitTheme = document.documentElement.classList.contains("dark") || 
        document.documentElement.classList.contains("light"); // if light class exists
      if (!hasExplicitTheme) {
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 10,
          background: isDark
            ? "linear-gradient(to right, rgba(17, 18, 34, 0.85) 0%, rgba(17, 18, 34, 0.6) 70%, rgba(17, 18, 34, 0) 100%)"
            : "linear-gradient(to right, rgba(244, 241, 236, 0.9) 0%, rgba(244, 241, 236, 0.6) 70%, rgba(244, 241, 236, 0) 100%)",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div style={{ marginBottom: "36px", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "28px", fontFamily: "var(--font-header)", marginBottom: "8px", fontWeight: "500", color: isDark ? "#FFFFFF" : "#2C2F35" }}>Welcome Back</h2>
            <p style={{ color: isDark ? "#9CA3AF" : "#6B7280", fontSize: "14px", lineHeight: "1.5" }}>
              Take a slow deep breath, and enter your credentials to return to your calm space.
            </p>
          </div>
          ...
          <div style={{ marginTop: "28px", textAlign: "center", fontSize: "14px" }}>
            <span style={{ color: isDark ? "#9CA3AF" : "#6B7280" }}>New to SereneMind? </span>
            <Link href="/register" style={{ color: isDark ? "#a78bfa" : "#5B7FA6", fontWeight: "600" }} className="auth-switch-link">
      ...
      {/* Right Column - Starry Garden Panel with Illustrated Hamster */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        >
          Pssst... I'm Sparky! Your secret entries and journals are 100% private and safe here.
          {/* Bubble tail pointer */}
          <div
            style={{
              position: "absolute",
        ...
        <div style={{ textAlign: "center", maxWidth: "380px", zIndex: 11 }}>
          <h3 style={{ fontSize: "22px", fontFamily: "var(--font-header)", marginBottom: "8px", fontWeight: "500", color: isDark ? "#FFFFFF" : "#2C2F35" }}>Your Safe Haven</h3>
          <p style={{ color: isDark ? "#EAE8E3" : "#4B5563", fontSize: "14.5px", lineHeight: "1.6", fontWeight: "500", textShadow: isDark ? "0 2px 4px rgba(0,0,0,0.5)" : "0 1px 2px rgba(255,255,255,0.8)" }}>
            Take this brief moment to disconnect from distractions. Your emotional resilience dashboard is waiting.
          </p>
        </div>
      </div>
